...
export default function InteractiveGlobe() {
  ...
  // Set up ESG Climate Sync coordinates on the globe (x, y, z coordinates in 3D space)
  const routes = [
    { name: "EMEA ➔ NA Clean Grid", color: "#34d399", start: { lat: 51.5074, lng: -0.1278 }, end: { lat: 40.7128, lng: -74.0060 } },
    { name: "APAC Renewable Net", color: "#fbbf24", start: { lat: 35.6762, lng: 139.6503 }, end: { lat: 37.7749, lng: -122.4194 } },
    { name: "EU Solar Offset Sync", color: "#38bdf8", start: { lat: 52.5200, lng: 13.4050 }, end: { lat: 28.6139, lng: 77.2090 } }
  ];
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const sphereGrad = ctx.createRadialGradient(cx - 18, cy - 18, 12, cx, cy, radius);
      sphereGrad.addColorStop(0, "#164e28");
      sphereGrad.addColorStop(0.6, "#092412");
      sphereGrad.addColorStop(1, "#030c06");
    ...
    <div className="w-full text-white flex flex-col items-center select-none">
      ...
      <div className="w-full flex items-center justify-between px-1 mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-extrabold text-[10px] text-brand-100 uppercase tracking-widest">Global ESG Offset Network</span>
        </div>
        <button 
