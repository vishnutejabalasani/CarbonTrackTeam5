...
public class EmissionFactor {
    ...
    private String activityType; // e.g., "car_km", "flight_hours", "kwh_coal", "meal_vegetarian"
    ...
    private BigDecimal emissionValueKgCO2e; // kg CO₂e per unit

    @Column(name = "source")
    private String source; // "IPCC", "EPA", "Custom"

    @Column(name = "description")
    private String description; // e.g., "Average petrol car emissions per km"
